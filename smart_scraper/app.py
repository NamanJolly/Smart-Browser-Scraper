...
default_instructions= f"""Extract the main articles displayed on the homepage '{url}'.
...
if st.button("Run Scraper"):
    ...
    if screenshot:
        st.image(screenshot, caption="Screenshot of the scraped page",
                 width="stretch")
    if result and result.articles:
        ...
        st.warning("No articles extracted. Please check the URL and instructions.")
